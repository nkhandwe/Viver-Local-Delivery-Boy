        ...
        body: Padding(
          ...
          child: GetBuilder<OrderController>(builder: (orderController) {
            ...
            if (controllerOrderModel != null) {
              ...
              _pickedUp =
                  controllerOrderModel.orderStatus == AppConstants.PICKED_UP;
              ...
              bool _restConfModel = Get.find<SplashController>()
                  ...
                  .orderConfirmationModel !=
                  'deliveryman';
              _showBottomView = (_parcel && _accepted) ||
                  _accepted ||
                  _confirmed ||
                  _processing ||
                  _handover ||
              ...
              _showSlider =
                  (_cod && _accepted && !_restConfModel && !_selfDelivery) ||
                      _handover ||
                      _pickedUp ||
                      (_parcel && _accepted);
            }
            ...
            _change_required = (double.parse(_cash_pay) - _order.orderAmount);
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    (_cod_payment_method_name.toString()),
                                    style: robotoMedium.copyWith(
                                        fontSize: Dimensions.FONT_SIZE_SMALL,
                                        color: Colors.black),
                                  ),
