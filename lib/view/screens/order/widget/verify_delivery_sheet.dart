...
class VerifyDeliverySheet extends StatelessWidget {
  ...
  VerifyDeliverySheet({@required this.currentOrderModel, @required this.verify, @required this.orderAmount, @required this.cod});
        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            (verify && orderController.otp.length != 4) ? SizedBox() : !orderController.isLoading ? CustomButton(
              ...
              onPressed: () {
                Get.find<OrderController>().updateOrderStatus(currentOrderModel, 'delivered').then((success) {
                  if(success) {
